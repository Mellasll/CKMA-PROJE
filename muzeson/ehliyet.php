  ...
  <main id="main" class="main-page">
    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <img src="img/objeler/ehliyet.JPG" alt="Speaker 1" class="img-fluid">
          </div>

          <div class="col-md-6">
            <div class="details">
              <p>Denizli’den Çanakkale’ye göç eden İsmail Güren Çanakkale’de geçimini kahvecilik yaparak sağlar. Kahvecilik yapmasının yanında arabalara da meraklı olan İsmail Bey, en büyük zevklerinden biri olan araba kullanmak için ehliyet almaya karar verir. Ehliyetlerin Belediye tarafından verildiği o günlerde ehliyet belgesi için Çanakkale Belediyesine müracaat eder. 1936 senesinde Kentin ilk ehliyet belgesine sahip olan İsmail Bey, Chevrolet Marka arabasını kullanmaya başlar. Kentin ilk arabasının sahibi olan İsmail Bey’in arabasına ilgi büyük olur. Kentliler Saat Kulesi Meydanında arabanın etrafını çevrelerler ve fotoğraf çektirirler. Ehliyet belgesi ve o günlere ait fotoğraf babasını 12 yaşında kaybeden Sayın Süleyman Güren tarafından Kent Müzesine bağışlanmıştır. Kentin bu önemli belgesi siz ziyaretçileri beklemektedir.</p><br>
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            ...
            <p>
             ...
             <div class="social-links">
              ...
              <a href="httpa://wwww.facebook.com/canakkalekentmuzesi.arsivi/" class="facebook"><i class="fa fa-facebook"></i></a>
