  ...
  <header id="header" class="header-fixed">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="index.php#intro" class="scrollto"><img src="img/logo.png" alt="" title="Murathan Sevinç" style="height:88px; width: 70px;"></a>
      </div>
    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        <div class="section-header">
          <h2>Çaydanlık</h2>
          <p>Objenin hikayesi:</p>
        </div>

        <div class="row">
          <div class="col-md-6">
            <img src="img/objeler/çaydanlık.JPG" alt="Speaker 1" class="img-fluid">
          </div>

          <div class="col-md-6">
            <div class="details">
              <p>Çelikel ailesi 1925 yılında Yalı’da kuru kahveci dükkanı açar. Aile esnaflıkta ilerlerken ailenin oğlu Niyazi Çelikel karşı komşunun kızı Hatice Hanım’a aşık olur. 1947 yılında mutlu bir evliliğe adım atarlar. Kentte Kuru Kahveci olarak tanınan ailenin maliyede muhasebecilik yapan oğlu Niyazi Bey ise çaya düşkündür. Eşi ile baş başa çay içmenin zevki onun için ayrı bir anlam taşır. Eşine, baş başa kaldıklarında içecekleri çay için özel bir çaydanlık alır. Hatice Hanım uzun yıllar aynı yastığa baş koyduğu sevgili eşini kaybettikten sonra onun hediye ettiği çaydanlığı yanından hiç ayırmaz. Eşinin yokluğunun acısını yaşarken ondan bir hatıra olarak, onunla paylaştığı özel anların anısını taşıyan çaydanlık ile mutlu günlerini hatırlar. Her an çaydanlık ile birliktedir. Kent dışına çıktığı yolculuklarda da çaydanlık onunladır. Eş dost ziyaretleri değildir yalnızca çaydanlığın gittiği yerler, alışkanlık haline getirilmiş kaplıcaya gidişlerde de yanındadır. Eskisi kadar evden çıkmaz olduğu şu günlerde vitrini süsleyen çaydanlığını Kent Müzesine bağışlar. Anıları artık yalnız değildir, çaydanlık ile birlikte Kent Müzesinde yaşamaktadır. Bundan böyle çaydanlık, bu naif aşkın duygu ve özlem dolu hikayesini sizlere anlatmak için bekliyor.</p><br>
              <h2 style="font-size: 15px;">Macide Aksu / ÇKM&a Müze Arşiv Sorumlusu </h2>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            ...
            <div class="social-links">
              ...
              <a href="https://wwww.facebook.com/canakkalekentmuzesi.arsivi/" class="facebook"><i class="fa fa-facebook"></i></a>
