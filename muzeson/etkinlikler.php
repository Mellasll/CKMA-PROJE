  ...
  ============================-->
    ...
    <section id="schedule" class="section-with-bg">
      <div class="container wow fadeInUp">
        ...
        <!-- <h3 class="sub-heading">başlık , açıklama vs</h3>-->
...
<!-- while başlangıç -->
 <?php 
             $say=0;
             $sorgu=$baglanti->prepare("SELECT * FROM etkinlikler where aktif=1 ORDER BY tarih DESC");
             $sorgu->execute();
            ...
            <div class="row schedule-item">
              <div class="col-md-2"><time><?php echo $select['tarih']; ?></time></div>
              <div class="col-md-10">
                <h4><?php echo $select['baslik']; ?>  <span><?php echo $select['name']; ?></span></h4>
                <p><?php echo $select['detay']; ?></p>
              </div>
            </div>
  <?php } ?> 
<!-- while bitiş -->
