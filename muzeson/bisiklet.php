    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        <div class="section-header">
          <h2>Yaşar Yohay’ın Bisikleti </h2>
          <p>Objenin hikayesi:</p>
        </div>

        <div class="row">
          <div class="col-md-6">
            <img src="img/objeler/bisiklet.JPG" alt="Speaker 1" class="img-fluid">
          </div>

          <div class="col-md-6">
            <div class="details">
              <p>
                1937’de Çanakkale'de doğan Yaşar Bey, Ezine’de çocukluğunu geçirir ve orada büyür. Terzide çıraklık yaparak geçimini sağlayan Yaşar Bey, evlenmeye karar verir. Ailesinin uygun gördüğü Rebeka ile tanıtırılır. Tanışmanın ardından Yaşar, Çanakkale’ye taşınır ve askere gider. Rebeka Hanım’ın babası Musevi geleneğinde önemli yer tutan drahoma geleneğine bağlı olarak damadına bir dükkan alır. Yaşar Bey, burada terzilik yapmaya başlar. Üç sene nişanlı kalmanın ardından Rebeka ile Yaşar evlenir. Yaşar, 1962 yılında terzi olarak başlattığı esnaflık hayatını 1972 yılında açtığı Yaşar Spor isimli spor malzemeleri satan dükkan ile devam ettirir. 2011 yılındaki vefatına kadar geçen sürede esnaf olarak Çarşı’da yer alan Yaşar Bey’in üzerinden inmediği aracı bisikleti olur. Kentte herkesin hafızasında bisikleti ile yer eden Yaşar Bey’in bu aracı eşi ve çocukları tarafından vefatının ardından Kent Müzesi’ne bağışlanmıştır. Yohay ailesinin Müzeyi ziyaretlerinde duygulu anlar yaşadığı, Müze’nin minik misafirlerinin ilgi ile baktığı bisiklet, ilerleyerek tamamladığı yolculuğunu, sahibinin anıları ile Müze’de devam ettiriyor.             </p><br>
