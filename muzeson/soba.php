  ...
  <main id="main" class="main-page">
    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <img src="img/objeler/soba.JPG" alt="Speaker 1" class="img-fluid">
          </div>

          <div class="col-md-6">
            <div class="details">
              <p>Çarşıda sobacılık yaparak kentin ısınma ihtiyacını karşılayan Selahattin Kalfa, çocuklarını sobacılıktan kazandığı para ile büyütür. Çocukları büyüyüp evlendiğinde gelinini kızı gibi görür. Oğlu Şahabettin Kalfa’nın eşi Aynur Kalfa öğretmendir. Derslerinde öğrencilerine materyal olarak kullanması için çocuklara küçükken yaptığı sobayı verir. Aynur Hanım’ın öğrencilere derslerde gösterdiği soba döner dolaşır eşi Şahabettin Kalfa vasıtasıyla Kent Müzesi Müze salonunda yerini alır. Şimdilerde Müzenin çocuk konuklarının dikkatini çeken soba, şirinliği ile kendisinden büyük sobaların yanında siz ziyaretçileri bekliyor.</p><br>
