  ...
  <header id="header" class="header-fixed">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="index.php" class="scrollto"><img src="img/logo.png" alt="" title="" style="height:88px; width: 70px;"></a>
      </div>
  ...
  <main id="main" class="main-page">
    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <img src="img/objeler/piyano.jpg" alt="Speaker 1" class="img-fluid">
          </div>

          <div class="col-md-6">
            <div class="details">
              <p>1880’li yıllarda üretilmiş olan, 1904 yılında Rum Kız Okulu olarak eğitime başlandığında müzik derslerinin yanı sıra ders aralarında da çocukların eğlencesi olan piyano, kentin en eski okullarından olan İstiklal İlköğretim Okulu tarafından Kent Müzesi’ne bağışlanmıştır. Piyanonun tuşlarındaki parmak izleri, tuşlarından yükselen sesler, aşkın, sanatın, heyecanın, üretimin belgesi olarak Kent Müze’sinde yaşamaktadır. Müze ziyaretçilerinin dokunmamak için kendileri ile savaştıkları piyano, yıllara meydan okuyarak, yaşanmışlıkları ile siz ziyaretçilerini bekliyor.</p><br>
