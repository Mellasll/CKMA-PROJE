    ...
    <section id="speakers-details" class="wow fadeIn">
      <div class="container">
        <div class="section-header">
          <h2>Çanka Gazoz Şişesi</h2>
          <p>Objenin hikayesi:</p>
        </div>

        <div class="row">
          <div class="col-md-6">
            <img src="img/objeler/gazoz.JPG" alt="Speaker 1" class="img-fluid">
          </div>

          <div class="col-md-6">
            <div class="details">
              <p>Çanakkale’de öğrenci olan 5 arkadaş, Eylül ayında bisiklet turu yapmaya karar verirler. Gezi sırasında karşılarına çıkan Atikhisar barajındaki eski mezarlıkta mezarlık üzerinde yazan Osmanlıca metinlerini okumaya niyetlenirler.</p>
 
              <p>Metinleri okurken daha önce Kent Müzesi’nde rastladıkları ÇANKA gazoz şişesinin bir eşinin mezarlardan birine saplanmış halde olduğunu görürler. </p> 

              <p>Kent Müzesi’ni ziyaretleri esnasında tanıştıkları 1966 yılında Naci İsmet Muhtaroğlu tarafından kurulan, 1980 yılına kadar faaliyetine devam eden ÇANKA gazozları ile bağlantı kuran gençler şişenin yerinin Kent Müzesi olduğuna karar verirler.</p>
              <p>5 arkadaştan ikisi Volkan Kızılırmak, Kadir Karagülle kent değeri olarak önemli bir yere sahip olan ÇANKA gazozlarına ait bu şişeyi Kent Müzesi’ne bağışlarlar. 
              </p><br>
