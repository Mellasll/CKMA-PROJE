...
if ($_POST) { // Sayfada post olup olmadığını kontrol ediyoruz.
    ...
    if ($kadi <> "" && $parola <> "" && $kul_yetki <> "" && $hata == "") { // Veri alanlarının boş olmadığını kontrol ettiriyoruz.
        //Değişecek veriler
        $satir = [                       
            'kadi' => $kadi,
            'parola' => $parola,
        ...
        $sql = "INSERT INTO kullanicilar SET kadi=:kadi, parola=:parola, kul_yetki=:kul_yetki;";
            ...
            <div class="card-body">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" name="kadi" placeholder="Kullanıcı Adı">
                    </div>
                    <div class="form-group">
                        <label>Parola</label>
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" name="kul_yetki" placeholder="Yetki">
                    </div>
